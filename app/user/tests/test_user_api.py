...
class PublicUserAPITest(TestCase):
    ...
    def test_password_restriction(self):
        '''Tests that the password must be more than 5 chars'''
        payload = {
            'email': 'test@gmail.com',
            'password': 'test',
            'name': 'Test'
    ...
    def test_create_token_invalid_credentials(self):
        ...
        payload = {'email': 'test@gmail.com', 'password': 'incorrect'}
        resp = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        ...
        resp = self.client.post(TOKEN_URL, {'email': 'email', 'password': ''})
...
class PrivateUserAPITests(TestCase):
    ...
    def test_post_me_not_allowed(self):
        '''Test that POST is not allowed on URL'''
